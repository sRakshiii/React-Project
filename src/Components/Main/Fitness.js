  ...
  return (
    ...
    <div className='Main'>
      ...
      <section className='bollyS2'>
        <h4 > Top Posts</h4>
        <div className='head'></div>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJLc6iX81UZAfkUkJryOdErFuQbbtN-82ZmSLWAxKtdnsWj63wvSV1F5UBT0rRYaiY5Mq2CFf6AYc&usqp=CAU&ec=48600113" alt="" className='natureImg' />
